...
> = {
  en: {
    ...
    home: {
      ...
      text: 'Konomic is being positioned as a premium multilingual legal brand for expats, property buyers, founders, and families who need clear guidance, fast orientation, and a more reliable way to handle legal matters in Tenerife.',
  ...
  de: {
    ...
    launchNoteTitle: 'Launch-Hinweis',
    launchNoteText:
      'Diese Version ist ein MVP mit Fokus auf Struktur, Design und SEO-Architektur. Für den finalen Launch werden echte Unternehmensdaten, Lead-Kanäle und juristisch geprüfte Texte benötigt.',
    home: {
      ...
      text: 'Konomic wird als mehrsprachige Premium-Marke für Expats, Immobilienkäufer, Unternehmer und Familien aufgebaut, die klare Orientierung und verlässliche juristische Unterstützung auf Teneriffa brauchen.',
  ...
  ru: {
    ...
    launchNoteTitle: 'Примечание по запуску',
    launchNoteText:
      'Эта версия — MVP с упором на структуру, дизайн и SEO-архитектуру. Для финального запуска понадобятся реальные данные компании, каналы заявок и юридически выверенные тексты.',
    home: {
      ...
      text: 'Konomic строится как премиальный многоязычный юридический бренд для экспатов, покупателей недвижимости, предпринимателей и семей, которым нужна ясность, скорость и надёжная поддержка на Тенерифе.',
  ...
  uk: {
    ...
    launchNoteTitle: 'Примітка до запуску',
    launchNoteText:
      'Ця версія — MVP із фокусом на структурі, дизайні та SEO-архітектурі. Для фінального запуску потрібні реальні дані компанії, канали заявок і юридично перевірені тексти.',
    home: {
      ...
      text: 'Konomic формується як преміальний багатомовний юридичний бренд для експатів, покупців нерухомості, підприємців і сімей, яким потрібні ясність, швидкість і надійна підтримка на Тенерифе.',
