      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.08fr_0.92fr] lg:px-10 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/uk/book-consultation" className="ui-button ui-button-primary rounded-full bg-[#1d252b] px-6 py-3 text-sm font-medium text-white hover:bg-[#11171b]">{copy.home.primaryCta}</Link>
            <Link href="/uk/contact" className="ui-button ui-button-secondary rounded-full border border-[#1d252b]/15 bg-white/80 px-6 py-3 text-sm font-medium text-[#1d252b] hover:border-[#1d252b]/35">{copy.home.secondaryCta}</Link>
          </div>
        </div>
