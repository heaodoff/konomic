      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-18 lg:grid-cols-[1.15fr_0.85fr] lg:px-10 lg:py-24">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/ru/book-consultation" className="rounded-full bg-[#1d252b] px-6 py-3 text-sm font-medium text-white transition hover:bg-[#11171b]">{copy.home.primaryCta}</Link>
            <Link href="/ru/contact" className="rounded-full border border-[#1d252b]/15 bg-white/80 px-6 py-3 text-sm font-medium text-[#1d252b] transition hover:border-[#1d252b]/35">{copy.home.secondaryCta}</Link>
          </div>
        </div>
