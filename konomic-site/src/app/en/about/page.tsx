  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
      <SectionIntro
        ...
        title="Konomic Digital SL. — a stronger legal brand for Tenerife’s international market"
        text="Konomic Digital SL. is being positioned as a premium multilingual legal support brand for foreign clients who need clarity, speed, and trust when dealing with Tenerife property, relocation, business, and legal matters."
      />
      <div className="mt-12 grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-[2rem] border border-black/5 bg-[#1f262d] p-8 text-white shadow-[0_30px_80px_rgba(26,31,36,0.14)]">
          <h2 className="text-2xl font-semibold tracking-tight">Public profile currently used on site</h2>
